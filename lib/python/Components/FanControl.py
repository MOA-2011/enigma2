...
class FanControl:
	...
	def createConfig(self):
		...
		for fanid in range(self.getFanCount()):
			...
			fan.pwm = ConfigSlider(default = 15, increment = 5, limits = (0, 255))	#IQON :default fan speed
			fan.vlt_standby = ConfigSlider(default = 5, increment = 5, limits = (0, 255))
			fan.pwm_standby = ConfigSlider(default = 5, increment = 5, limits = (0, 255)) #IQON : default pwm slider
